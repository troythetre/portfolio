...
interface RestoreBtnProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  // Добавляем onClick как часть свойств компонента
  onClick?: () => void;
}

const RestoreBtn = forwardRef(
  (props: RestoreBtnProps, ref: ForwardedRef<HTMLButtonElement>) => {
...
RestoreBtn.displayName = "RestoreBtn";
