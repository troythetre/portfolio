...
exports.addResponseFromCSV = async function(req, res, next) {
            ...
            upload.single("csvfile")(req, res, async function(err) {
                if (err instanceof multer.MulterError) {
                    ...
                    return res.status(400).json({
                        error: "File upload error. Please upload key 'csvfile' with a CSV file.",
                    });
                }
                ...
                if (!isValidHeaders) {
                    return res.status(400).json({
                        error: "CSV file is missing required columns, required: [ 'question', 'answer', 'software', 'topic', 'subtopic' ].",
                    });
                }
