...
exports.createOrUpdateQuestion = async (db, existingProposal, updated) => {
    const { userEmail, operationType, question } = updated;
    ...
    const newChangeValue = newChange(userEmail, operationType, PROPOSAL_CONTENT.QUESTIONS, question).toObject();
    ...
    await db.update({ questions: existingProposal.questions, versionHistory: existingVersionHistory });
