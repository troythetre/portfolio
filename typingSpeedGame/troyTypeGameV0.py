...
class TypeSpeedGUI:
    ...
    def __init__(self):
        ...
        self.input_entry = self.input_entry = tk.Entry(self.frame, width=40, font=("Helvetica", 24))
        ...
        self.reset_button = tk.Button(self.frame, text="Reset", command=self.reset())  # This line was modified : self.root --> self.frame
        self.reset_button.grid(row=20, column=0, columnspan=2, padx=5, pady=10)
